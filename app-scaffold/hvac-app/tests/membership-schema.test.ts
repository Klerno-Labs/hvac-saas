...
describe('membership schema types', () => {
  it('MembershipPlanCreateInput has required fields', () => {
    const _check: Prisma.MembershipPlanCreateInput = {
      name: 'Annual HVAC Plan',
      cadence: 'annual',
  ...
  it('MembershipCreateInput has required fields', () => {
  ...
  it('MembershipEquipmentCreateInput has required fields', () => {
    const _check: Prisma.MembershipEquipmentCreateInput = {
      organization: { connect: { id: 'org_1' } },
      membership: { connect: { id: 'mem_1' } },
      equipment: { connect: { id: 'equip_1' } },
